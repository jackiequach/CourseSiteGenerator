...
function loadJSONData(data) {
    ...
    for (var i = 0; i < data.holidays.length; i++) {
        ...
        var holidayDate = new ScheduleDate(parseInt(holidayData.month), parseInt(holidayData.day));
    ...
    for (var i = 0; i < data.lectures.length; i++) {
        ...
        var lectureDate = new ScheduleDate(parseInt(lectureData.month), parseInt(lectureData.day));
    ...
    for (var i = 0; i < data.references.length; i++) {
        ...
        var refDate = new ScheduleDate(parseInt(refData.month), parseInt(refData.day));
    ...
    for (var i = 0; i < data.recitations.length; i++) {
        ...
        var recDate = new ScheduleDate(parseInt(recData.month), parseInt(recData.day));
    ...
    for (var i = 0; i < data.hws.length; i++) {
        ...
        var hwDate = new ScheduleDate(parseInt(hwData.month), parseInt(hwData.day));
